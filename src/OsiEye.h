...
namespace osiris
{
    ...
    public:
        ...
        void loadOriginalImageFromBuffer(const std::string &rFilename);
        ...
        void convertIplImageToBuffer(const IplImage *image, std::vector<uint8_t> &buffer, int &width, int &height, int &channels);
        ...
        void saveBufferIrisCodeAndNormalizedMasks(const std::string &rFilename);
        ...
        void decompressBuffer(const std::vector<uint8_t> &input, std::vector<uint8_t> &output, size_t decompressed_size);
    ...
    private:
        ...
        /** The original image corresponding to the eye (input only). */
        // IplImage *mpOriginalImageBuffer;
        ...
        void loadImageFromBuffer(const std::string &rFilename, IplImage **ppImage);
        ...
        void compressBuffer(const std::vector<uint8_t> &input, std::vector<uint8_t> &output);
        void saveBuffersToFile(const std::string &output_file, const std::vector<uint8_t> &buffer1, int width1, int height1, int channels1,
