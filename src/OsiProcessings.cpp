...
namespace osiris
{
    ...
    {
        std::cout << "Start of segment function" << std::endl;
        // Check arguments
        //////////////////
                                     ...
                                     int maxPupilDiameter)
    {
        ...
        //     std::cout << "Horizontal gradients (gh):" << std::endl;
        // for (int i = 0; i < gh->height; ++i)
        // {
        //     for (int j = 0; j < gh->width; ++j)
        //     {
        //         std::cout << ((float*)(gh->imageData + gh->widthStep * i))[j] << " ";
        //     }
        //     std::cout << std::endl;
        // }
        ...
        std::cout << "Created filters (fh and fv) with size: " << filter_size << std::endl;
        ...
        std::cout << "Pupil detected, x = " << x << ", y = " << y << ", r = " << r << std::endl;
